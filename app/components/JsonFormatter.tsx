                ...
                <div className="relative">
                  ...
                  {shareUrl && (
                    <div className="absolute right-0 top-full z-20 mt-2 w-80 rounded-lg border border-slate-200 bg-white p-3 shadow-lg dark:border-slate-700 dark:bg-slate-800">
                      ...
                      <div className="mt-2 break-all rounded-lg border border-indigo-200 bg-indigo-50 p-2.5 font-mono text-xs text-indigo-900 dark:border-indigo-800 dark:bg-indigo-950/40 dark:text-indigo-200">
                        {shareUrl}
                      </div>
                      <button
                        type="button"
                        onClick={copyShareUrl}
                        className="mt-2 inline-flex items-center gap-1 rounded-md px-2 py-1 text-xs font-medium text-indigo-600 transition hover:bg-indigo-50 dark:text-indigo-400 dark:hover:bg-indigo-950/40"
                      >
                        {shareCopied ? (
                          <Check className="h-3.5 w-3.5 text-emerald-500" />
                        ) : (
